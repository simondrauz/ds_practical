...
\begin{frame}{Trajectron++}
  \begin{columns}
    \begin{column}{0.52\textwidth}
      \begin{itemize}
        \item<1-> Probabilistic trajectory prediction model, state-of-the-art
              at publication
              \textnormal{\small[Salzmann et al., 2020]}
        \item<2-> \emph{Spatio-temporal graph encoder}
        \begin{itemize}
          \item LSTM encodes each agent's history
        ...
        \item<4-> Handles \emph{heterogeneous} agent types jointly
              (pedestrian, bicycle, motorcycle, vehicle) and integrates HD map context
